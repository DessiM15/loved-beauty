...
type Props = { compact?: boolean; source?: string; className?: string };

export function NewsletterForm({ compact = false, source = "site", className }: Props) {
    ...
    <form onSubmit={onSubmit} className={cn("w-full", className)}>
      <div className={cn("flex gap-2", compact ? "max-w-sm" : "mx-auto max-w-md")}>
        ...
        <button
          ...
          className={cn("btn btn-primary shrink-0", compact ? "px-4" : "px-6")}
